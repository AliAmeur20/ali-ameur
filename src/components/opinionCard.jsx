const OpinionCard = ({fullName, role, opinion}) => {
    return (
        <div class="flex flex-col justify-between overflow-hidde rounded-3xl bg-base-100 text-base shadow-2xl px-6 md:px-10 py-2">
            <div class="md:py-2">
                <p class="mt-6 md:text-lg font-extrabold">"{opinion}"</p>
            </div>
            <div class="py-4">
                <hr class="bg-current h-[1px] border-0" />
                <div class="mt-5">
                    <p class="text-2xl md:text-4xl font-bold">{fullName}</p>
                    <p class="md:text-lg opacity-80">{role}</p>
                </div>
                <div class="flex gap-x-2 mt-3">
                    <button class="custom-primary-white-btn">
                    ...
                    <button class="custom-primary-white-btn">
                        <span className="text-xl md:text-2xl font-extrabold">in</span>
                    </button>
                </div>
            </div>
        </div>
